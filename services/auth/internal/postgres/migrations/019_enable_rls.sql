...
CREATE POLICY tenant_isolation_sessions ON active_sessions USING (tenant_id = current_setting('app.tenant_id', true)::text);
...
-- سياسة للمشرف العام (super admin) لتجاوز العزل
